...
odoo.define('pos_retail.load_models', function (require) {
    ...
    models.load_models([
        {
            ...
            domain: function (self) {
                return ['|', ['id', 'in', self.config.stock_location_ids], ['id', '=', self.config.stock_location_id[0]], ['usage', '=', 'internal']];
            },
    ...
    var extend_models = [
        ...
        //     label: 'Employees',
        //     model: 'hr.employee',
        //     fields: ['name', 'id', 'pos_security_pin', 'barcode'],
        //     context: {sudo: true},
        ...
        },
        {
            ...
            loaded: function (self, lots) {
                lots = lots.filter(l => {
                    ...
                    if (!l['product_qty'] || l['product_qty'] <= 0)
                        is_visible = false;
