...
class StockLocation(models.Model):
    ...
    def get_stock_data_by_location_ids(self, product_ids=[], location_ids=[]):
        stock_datas = {}
        _logger.info('[get_stock_data_by_location_ids] product_ids %s location_ids %s' % (product_ids, location_ids))
        for location_id in location_ids:
            ...
            _logger.info('Total products need loading stock on hand: %s' % len(product_ids))
        ...
        _logger.info('[get_stock_data_by_location_ids] DONE')
        return stock_datas