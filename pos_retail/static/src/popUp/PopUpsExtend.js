odoo.define('pos_retail.popups', function (require) {
    ...
    var popup_selection_tags = PopupWidget.extend({
        ...
        show: function (options) {
            ...
            this.selected_order = this.pos.get_order();
            this.tags_selected = {};
            let selected_orderline = this.selected_order.selected_orderline;
            let tag_selected = []
            if (selected_orderline) {
                tag_selected = selected_orderline['tags'];
            }
                ...
                if (tag) {
                    if ($(this).closest('.tag').hasClass("item-selected") == true) {
                        ...
                        if (selected_orderline) {
                            ...
                            for (let i = 0; i < self.selected_order.orderlines.models.length; i++) {
                                self.remove_tag_out_of_line(self.selected_order.orderlines.models[i], tag)
                            }
                        }
                    } else {
                        $(this).closest('.tag').toggleClass("item-selected");
                        ...
                        if (selected_orderline) {
                            ...
                            for (let i = 0; i < self.selected_order.orderlines.models.length; i++) {
                                self.add_tag_to_line(self.selected_order.orderlines.models[i], tag)
                            }
                        }
