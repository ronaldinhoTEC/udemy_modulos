odoo.define('pos_retail.buttons', function (require) {
    ...
    var buttonClearCache = screens.ActionButtonWidget.extend({
        template: 'buttonClearCache',
        init: function (parent, options) {
            this._super(parent, options);
        },
        button_click: function () {
            const self = this
            this.pos._validate_by_manager("this.pos.removeCache()", 'Remove Cache');
        },
    });
    var buttonGetModifiersBackendAllModels = screens.ActionButtonWidget.extend({
        template: 'buttonGetModifiersBackendAllModels',
        init: function (parent, options) {
            this._super(parent, options);
        },
        button_click: function () {
            ...
            return this.pos.gui.show_popup('confirm', {
                title: _t('Great Job'),
                body: 'Se ha actualizado la base de datos de clientes y productos',
            });
        },
    });
    var buttonVisibilityCartDetail = screens.ActionButtonWidget.extend({
        template: 'buttonVisibilityCartDetail',
        init: function (parent, options) {
            this._super(parent, options);
        },
        button_click: function () {
    ...
    var buttonViewTickets = screens.ActionButtonWidget.extend({
        template: 'buttonViewTickets',
        init: function (parent, options) {
            this._super(parent, options);
        },
        button_click: function () {
            return this.pos.gui.show_screen('tickets');
        },
    });
    var buttonAddNewOrder = screens.ActionButtonWidget.extend({
        template: 'buttonAddNewOrder',
        init: function (parent, options) {
            this._super(parent, options);
        },
        button_click: function () {
    ...
    var buttonRemoveSelectedOrder = screens.ActionButtonWidget.extend({
        template: 'buttonRemoveSelectedOrder',
        init: function (parent, options) {
            this._super(parent, options);
        },
        button_click: function () {
    ...
    /*DQ: La asignación de botones a la vista se compone en orden inverso*/
    screens.define_action_button({
        'name': 'buttonRemoveSelectedOrder',
        'widget': buttonRemoveSelectedOrder,
        'condition': function () {
            return true;
        },
    });
    screens.define_action_button({
        'name': 'buttonAddNewOrder',
        'widget': buttonAddNewOrder,
        'condition': function () {
            return true;
        },
    });
    screens.define_action_button({
        'name': 'buttonViewTickets',
        'widget': buttonViewTickets,
        'condition': function () {
            return true;
        },
    });
    ...
    screens.define_action_button({
        'name': 'buttonVisibilityCartDetail',
        'widget': buttonVisibilityCartDetail,
        'condition': function () {
            return true;
        },
    });
    screens.define_action_button({
        'name': 'buttonGetModifiersBackendAllModels',
        'widget': buttonGetModifiersBackendAllModels,
        'condition': function () {
            return true;
        },
    });
    screens.define_action_button({
        'name': 'buttonClearCache',
        'widget': buttonClearCache,
        'condition': function () {
            return true;
        },
    });
