...
class Presupuesto(models.Model):
    ...
    categoria_director_id = fields.Many2one('res.parter.category', string='Categoria del Director', default= lambda self: self.env['res.partner.category'].search([('name','=','Director')]))
