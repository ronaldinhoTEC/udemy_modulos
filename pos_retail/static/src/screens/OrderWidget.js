...
odoo.define('pos_retail.screen_order_widget', function (require) {
    ...
    screens.OrderWidget.include({
        ...
        set_reason_return: function () {
            var self = this;
            var order = self.pos.get_order();
            if (order && order.selected_orderline && self.pos.return_reasons) {
                if (self.pos.return_reasons.length > 0) {
                    return self.gui.show_popup('popup_selection_tags', {
                    ...
                    return self.pos.gui.show_popup('confirm', {
                        title: _t('Warning'),
                        body: _t('Your poss missed setup Reasons Return. Please go to Retail Operation / Tags menu. And create some reasons return with field [Is return Reason] is checked'),
                    })
                }
            } else {
                return self.pos.gui.show_popup('confirm', {
